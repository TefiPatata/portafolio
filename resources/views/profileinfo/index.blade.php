        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('profileinfo.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('profileinfo.show',$profileinfo->id) }}">
                                                            View
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('profileinfo.edit',$profileinfo->id) }}">
                                                            Edit
                                                        </a>
                                                        <form
                                                            action="{{ route('profileinfo.destroy',$profileinfo->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
