                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive min-vh-100">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                @forelse ($skillssections as $skillssection)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select skillssection"></td>
                                        <td>{{ ++$i }}</td>
                                        
											<td>{{ $skillssection->title }}</td>
											<td>{{ $skillssection->description }}</td>
											<td>{{ $skillssection->skills_id }}</td>
											<td>{{ $skillssection->education_id }}</td>
											<td>{{ $skillssection->certificate_id }}</td>
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $skillssections->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
